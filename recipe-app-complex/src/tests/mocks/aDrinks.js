const cocktailGlass = 'CocktailGlass';
const ordinaryDrink = 'Ordinary Drink';
const lemonJuice = 'Lemon Juice';
const highBallGlass = 'High Ball Glass';
const orangejuice = 'Orangejuice';
...
const aDrinks = {
  drinks: [
    ...
    },
    {
      ...
      strAlcoholic: 'Alcoholic',
      strGlass: highBallGlass,
      strInstructions: 'Pour schnapps, orange juice, and cranberry juice over ice in ahighBallGlass Top with club soda and serve.',
    ...
    },
    {
      ...
      strAlcoholic: 'Alcoholic',
      strGlass: highBallGlass,
      strInstructions: 'Pour all of the ingredients into ahighBallGlassalmost filled with ice cubes. Stir well.',
